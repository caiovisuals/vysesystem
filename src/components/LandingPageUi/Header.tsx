    ...
    return (
        <header className="p-8 flex flex-row items-center justify-between">
            ...
            <div className="flex flex-row gap-4">
                ...
                <Link href="/login" className="text-center py-1 px-4 rounded-full transition-all duration-300 ease-in-out hover:text-[var(--sub-text)]">Login</Link>
                <Link href="/register" className="text-center bg-[var(--foreground)] hover:bg-[var(--middleground)] py-1 px-4 rounded-full transition-all duration-300 ease-in-out">Cadastre-se</Link>
            </div>
        </header>
    )
}